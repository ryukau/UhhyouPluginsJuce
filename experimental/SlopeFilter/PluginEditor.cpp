...
void Editor::resized()
{
  ...
  groupLabels.push_back(
    {"Slope Filter", Rect{eqLeft0, eqTop0, sectionWidth, labelHeight}});

  labels.push_back({"Type", Rect{eqLeft0, eqTop1, labelWidth, labelHeight}});
  shelvingType.setBounds(Rect{eqLeft1, eqTop1, labelWidth, labelHeight});

  labels.push_back({"Slope Start [Hz]", Rect{eqLeft0, eqTop2, labelWidth, labelHeight}});
  startHz.setBounds(Rect{eqLeft1, eqTop2, labelWidth, labelHeight});

  labels.push_back({"Slope [dB/oct]", Rect{eqLeft0, eqTop3, labelWidth, labelHeight}});
  slopeDecibel.setBounds(Rect{eqLeft1, eqTop3, labelWidth, labelHeight});
